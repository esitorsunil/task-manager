          ...
          >
            <thead className="bg-light">
              <tr className="align-middle border-bottom text-secondary">
                <th style={{ position: 'sticky', left: 0, width: '400px', zIndex: 2, backgroundColor: '#f8f9fa' }} className="py-3 px-3">
                  ...
                  <td className="py-3 px-3">
                    {task.attachments && task.attachments.length > 0 ? (
                      <div className="d-flex align-items-center gap-2">
                        ...
                        >
                          <i className="bi bi-paperclip"></i> {task.attachments[task._currentFileIndex || 0]?.name}
                        </a>
